...
{% include figure.html img="ADDIE.png" alt="the ADDIE model caption="The ADDIE Model; Image from Instructional System Design (ISD): Using the ADDIE Model by Steven J. McGriff" width="75%" %}
